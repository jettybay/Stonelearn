...
const categories = [
  {
    name: "Edutech",
    href: "/categories/edutech",
    description: "Scale learning with modern school management tools",
  },
  {
    name: "Fintech",
    href: "/categories/fintech",
    description: "Robust payment & banking infrastructure",
  },
  {
    name: "Healthtech",
    href: "/categories/healthtech",
    description: "Streamline patient care and clinic operations",
  },
  {
    name: "Ecommerce",
    href: "/categories/ecommerce",
    description: "Launch and scale your online retail brand",
  },
];
