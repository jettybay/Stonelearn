          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg text-gray-600">
                Launch a fully branded LMS for medical training.
                Manage professionals, clinical courses, quizzes,
      ...
      <section className="border-y bg-gray-50 py-16">
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-8 px-6 md:grid-cols-4">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-500">Professionals</p>
          </div>
      ...
      >
        <div className="mx-auto max-w-7xl px-6">
          ...
          <SectionHeader
            ...
            title="Medical Training for the Digital Age"
            description="Stonelearn gives medical centers the tools required to manage continuous education."
          />
<div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
  ...
  <FadeIn>
    <FeatureCard
      ...
      description="Each facility gets its own colors, logo and subdomain."
    />
  </FadeIn>
      ...
      <section className="bg-gray-50 py-24">
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <SectionHeader
            ...
            title="Every Facility Gets Its Own Identity"
            ...
            <div className="rounded-2xl bg-[var(--brand-bg)] p-6">
              ...
              <div className="mt-4">
                ...
                <div className="mt-2 rounded-xl bg-[color-mix(in_oklab,var(--brand-primary),white_85%)] p-4 text-[var(--brand-primary)]">
                  Your organization theme updates instantly.
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-gray-50 py-24">
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-12 space-y-4">
            ...
            <FAQItem
              question="Can I use our facility colors?"
              answer="Yes. Every healthcare entity can customize branding."
            />

            <FAQItem
              question="Do medical staff receive certificates?"
              answer="Yes. Certificates can be generated automatically."
            />

            <FAQItem
              question="Can doctors upload surgical videos?"
              answer="Absolutely. Medical professionals can upload high-resolution training videos."
            />
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="rounded-[32px] bg-[#722F37] p-16 text-center text-white">
            ...
            <p className="mt-6 text-lg text-white/80">
              Start building your medical training portal today.
            </p>
